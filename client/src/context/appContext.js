...
const AppProvider = ({children}) => {
    ...
    authFetch.interceptors.response.use((response) => {
        response.headers['Authorization'] = `Bearer ${state.token}`
        return response
    }, (error) => {
    ...
    return <AppContext.Provider value={{...state, displayAlert, registerUser, loginUser, setupUser, toggleSidebar, logoutUser, updateUser,
     handleChange, clearValues, createJob, getJobs, setEditJob,deleteJob, editJob, showStats, clearFilters, changePage}}>
        {children}
    </AppContext.Provider>
}
